...
This repository currently implements **Phase 1 and Phase 2** of the roadmap
in [`ROADMAP.md`](ROADMAP.md): a working multitrack recorder/player, a real
per-track effects chain (EQ, high/low-pass, compressor, delay, reverb), clip
split/delete/fade, sample-rate-aware import, and export driven by the
